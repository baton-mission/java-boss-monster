...
public class PlayerOption {
    public static final int PLAYER_NAME_MAXIMUM_LENGTH_LIMIT = 5;
    public static final int PLAYER_MINIMUM_HP_LIMIT = 1;
    public static final int PLAYER_MAXIMUM_HP_LIMIT = 200;
