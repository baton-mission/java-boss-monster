...
class BossMonsterHpTest {
    ...
    @DisplayName("유효한 범위의 HP 값으로 BossMonsterHp 생성자를 호출하면, BossMonsterHp 인스턴스가 생성된다.")
    @Test
    ...
    @DisplayName("유효범위보다 낮은 HP 값으로 BossMonsterHp 생성자를 호출하면, 예외가 발생한다.")
    @Test
    ...
    @DisplayName("유효범위보다 높은 HP 값으로 BossMonsterHp 생성자를 호출하면, 예외가 발생한다.")
    @Test
